    ...
    >
      ...
      <section className="py-24 bg-slate-100/80 dark:bg-[#0B1120]/60 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Mission Card */}
            <Reveal>
              <div className="bg-white/90 dark:bg-brand-card/70 backdrop-blur-md p-10 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700/50 relative overflow-hidden">
                 <div className="absolute top-0 right-0 p-8 opacity-5">
                    <Target size={150} />
                 </div>
                 <div className="h-14 w-14 rounded-full bg-brand-accent/10 flex items-center justify-center text-brand-accent mb-6">
                    <Target size={28} />
                 </div>
            ...
            <Reveal delay={0.2}>
              <div className="bg-white/90 dark:bg-brand-card/70 backdrop-blur-md p-10 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700/50 relative overflow-hidden">
                 ...
                 <div className="h-14 w-14 rounded-full bg-brand-success/10 flex items-center justify-center text-brand-success mb-6">
                    <Eye size={28} />
                 </div>
      ...
      <section className="py-24 border-y border-slate-200 dark:border-slate-800 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
           <Reveal>
             <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Our Core Values</h2>
             <p className="text-slate-600 dark:text-slate-300 mb-16 font-medium">These principles guide everything we do at Oberon Services.</p>
           </Reveal>
           ...
           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <Reveal key={i} delay={i * 0.1}>
                  <div className="bg-white/80 dark:bg-slate-900/60 backdrop-blur-md p-8 rounded-xl border border-slate-200 dark:border-slate-700/50 hover:border-brand-accent transition-colors shadow-sm">
                     <div className="mx-auto h-12 w-12 bg-slate-200 dark:bg-slate-800 rounded-lg flex items-center justify-center text-brand-accent mb-4">
                        <val.icon size={24} />
                     </div>
      ...
      <section className="py-24 bg-slate-100/80 dark:bg-[#0B1120]/60 backdrop-blur-sm">
         <div className="max-w-4xl mx-auto px-4 text-center">
            <Reveal>
              ...
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-8">Expert Security Professionals</h2>
              <div className="bg-white/90 dark:bg-slate-900/80 p-8 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700/50 text-left backdrop-blur-md">
