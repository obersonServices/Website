        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <section className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-6">Service Overview</h2>
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {service.features.map((feature, idx) => (
                  <div key={idx} className="flex items-start p-4 bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 shadow-sm hover:border-brand-accent/50 transition-colors">
            ...
            <section>
               <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Business Benefits</h3>
               <ul className="space-y-4">
                 {service.benefits.map((benefit, idx) => (
                   <li key={idx} className="flex items-start p-3 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
          ...
          <div className="lg:col-span-1">
            <div className="bg-slate-100 dark:bg-slate-900 p-8 rounded-xl border border-slate-200 dark:border-slate-800 sticky top-24 shadow-lg">
              <div className="mb-8">
                ...
                <ul className="space-y-3">
                  {service.whoIsItFor.map((item, idx) => (
                    <li key={idx} className="text-slate-600 dark:text-slate-400 text-sm pl-4 border-l-2 border-slate-300 dark:border-slate-700">
                      {item}
                    </li>
                  ))}
                </ul>
